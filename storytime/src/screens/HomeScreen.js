    ...
    return (
      <View style={{ flex: 1, marginBottom: 15 }}>
        <Pressable onPress={() => navigation.navigate("Player", { story: item })}>
          ...
          <Text style={{ color: "#fff", paddingTop: 5, fontSize: 12 }}>{truncateText(item.publisher, 16)}</Text>
        </Pressable>
      </View>
    );
  };
  ...
  return (
    <SafeAreaView style={tw`flex-1 bg-[#291F4E] text-white px-3`}>
        ...
        >
          {showDropdown ? (
            <View style={tw`text-black bg-white rounded`}>
                 ...
                 searchTerms && searchTerms.length > 0? (
                  ...
                  return (
                    <Pressable onPress={() => selectSearchItem(searchTerm)}>
                      <Text style={{ color: "#000", paddingVertical: 2, paddingLeft: 10 }}>
                        {searchTerm}
                      </Text>
                    </Pressable>
                  );
              ...
              <Pressable onPress={() => navigation.navigate("Search", { searchTerm: "Ramayan" })}>
                <Text style={{ color: "#000", paddingVertical: 2, paddingLeft: 10 }}>Ramayan</Text>
              </Pressable>
              <Pressable onPress={() => navigation.navigate("Search", { searchTerm: "Cricket" })}>
                <Text style={{ color: "#000", paddingVertical: 2, paddingLeft: 10 }}>Cricket</Text>
              </Pressable>
              <Pressable
                onPress={() => navigation.navigate("Search", { searchTerm: "Kid Stories" })}
              >
                <Text style={{ color: "#000", paddingVertical: 2, paddingLeft: 10 }}>
                  Kid Stories
                </Text>
      ...
      <View>
        ...
        >
          <Text style={{ color: "#fff", fontSize: 18, fontFamily: "Roboto-Medium" }}>Popular</Text>
